...
export default function AuthLayout({ children }: IProps) {
  return (
    <main className="grid grid-cols-1 md:grid-cols-2">
      ...
      <section className="hidden md:grid bg-[url('/assets/images/login-hero.webp')] bg-no-repeat bg-[length:100%_100%] px-6 xl:px-12 py-16">
        <article
        ...
        >
          ...
          <p className="text-base xl:text-xl text-white font-satoshi-bold tracking-[-0.4px]">
